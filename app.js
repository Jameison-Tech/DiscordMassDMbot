...
bot.on("ready", () => {
    clear();
    console.log('______');
    bot.user.setActivity('shoppy.gg/@JameisonKeys', { url: "https://github.com/Jameison-Tech", type: 'Shopping at' })
...
function clear() {
    ...
    console.log("\n     Don't forget to apply the proper permissions in Discord. ");
    console.log("\n     https://github.com/Jameison-Tech. ");
